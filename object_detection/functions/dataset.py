...
# yolo数据集转VOC数据集
def yolo2voc():
    voc_annotations = 'E:\code_python\_mvi_\data/annotations/'
    yolo_txt = 'E:\code_python\_mvi_\data\label/'
    img_path = 'E:\code_python\_mvi_\data\image/'
    labels = ['0', '1']  # label for datasets
    # 图像存储位置
